...
/**
 * Tests for Selendroid Test App.
 * Please boot Emulator-Api19-Default before running tests:
...
public class SelendroidAppTests {
    ...
    public static void setUp() throws IOException, FindFailed {
        s = new Screen();
        ImagePath.setBundlePath("src/test/java/demo_06_sikuli/selendroidtestapp/");
